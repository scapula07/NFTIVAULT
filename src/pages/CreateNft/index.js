...
export default function CreateNft() {
    ...
    const [fileVideo, setFile] = useState({ });
  ...
  const mintNftItem =async()=>{
   ...
   const options = {
      ...
      body: JSON.stringify({
        chain: 'goerli',
        contract_address: '0x363225aE4A76848DCdEAF53ED97838905Cda7eD1',
        metadata_uri: 'https://gateway.pinata.cloud/ipfs/QmbKWE65nNvczADYAb8KtwQcm7CseBwr33FPjgByBKvbXL/',
  ...
  return (
       ...
       <FileUpload fileVideo={fileVideo} setFile={setFile}  setDataCid={setDataCid}/>
       </main>
       <main className='pt-8'>
